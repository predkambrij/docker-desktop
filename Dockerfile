...
#      for i in *; do [ $i == systemd-tmpfiles-setup.service ] || rm -f $i; done) && \
    ...
    rm -rf /etc/systemd/system/systemd-remount-fs.service && \
    rm -rf /etc/systemd/system/systemd-journald.socket && \
    rm -rf /etc/systemd/system/systemd-journald.service && \
    rm -rf /etc/systemd/system/systemd-journald-dev-log.socket && \
    rm -rf /etc/systemd/system/systemd-journald-audit.socket && \
    rm -rf /etc/systemd/system/systemd-journal-flush.service && \
    ...
    rm -rf /etc/systemd/system/upower.service && \
    rm -rf /etc/systemd/system/systemd-logind.service && \
